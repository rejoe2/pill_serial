...
* Sanguino          13        14         12
*
* Adopted Sketch from ranseyer https://github.com/ranseyer/MySensors-HW/blob/master/Experimental/GW-STM32-RS485-RFM/MyS-GW-MAPLE-RS485/MyS-GW-MAPLE-RS485.ino
* For use with CAN Transceiver - no DE needed...
*/

//#include "general.h" // from main.c
